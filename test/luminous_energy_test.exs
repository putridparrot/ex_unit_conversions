...
defmodule PutridParrot.Units.LuminousEnergy do
    ...
    test "Convert known LumenHour to LumenSecond" do
        assert_in_delta PutridParrot.Units.LumenHour.to_lumensecond(109.0), 392400.0, 0.01;
    ...
    test "Convert known LumenMinute to LumenSecond" do
        ...
        assert_in_delta PutridParrot.Units.LumenMinute.to_lumensecond(8000.0), 480000.0, 0.01;
    ...
    test "Convert known LumenSecond to LumenHour" do
        ...
        assert_in_delta PutridParrot.Units.LumenSecond.to_lumenhour(200600.0), 55.7222, 0.01;
