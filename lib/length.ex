...
defmodule PutridParrot.Units.Centimetres do
  ...
  """
  def to_kilometres(value), do: value / 100_000.0
  ...
  """
  def to_miles(value), do: value / 160_934.4
...
defmodule PutridParrot.Units.Kilometres do
  ...
  """
  def to_millimetres(value), do: value * 1_000_000.0

  @doc """
  Converts the supplied Kilometres value to Centimetres
  """
  def to_centimetres(value), do: value * 100_000.0
...
defmodule PutridParrot.Units.Miles do
  ...
  """
  def to_millimetres(value), do: value * 1_609_344.0

  @doc """
  Converts the supplied Miles value to Centimetres
  """
  def to_centimetres(value), do: value * 160_934.4
...
defmodule PutridParrot.Units.Millimetres do
  ...
  """
  def to_kilometres(value), do: value / 1_000_000.0
  ...
  """
  def to_miles(value), do: value / 1_609_344.0
...
defmodule PutridParrot.Units.NauticalMiles do
  ...
  """
  def to_millimetres(value), do: value * 1_852_000.0

  @doc """
  Converts the supplied Nautical Miles value to Centimetres
  """
  def to_centimetres(value), do: value * 185_200.0
