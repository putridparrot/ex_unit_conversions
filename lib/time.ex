...
defmodule PutridParrot.Units.Centuries do
  ...
  """
  def to_hours(value), do: value * 876_000.0
...
defmodule PutridParrot.Units.Hours do
  ...
  """
  def to_centuries(value), do: value / 876_000.0
end
...
defmodule PutridParrot.Units.Microseconds do
  ...
  """
  def to_months(value), do: value / 2_629_746_000_000.0
...
defmodule PutridParrot.Units.Milliseconds do
  ...
  """
  def to_months(value), do: value / 2_629_746_000.0

  @doc """
  Converts the supplied Milliseconds value to Years
  """
  def to_years(value), do: value / 31_556_952_000.0
...
defmodule PutridParrot.Units.Minutes do
  ...
  """
  def to_years(value), do: value / 525_600.0
...
defmodule PutridParrot.Units.Months do
  ...
  """
  def to_nanoseconds(value), do: value * 2_629_746_000_000_000.0

  @doc """
  Converts the supplied Months value to Microseconds
  """
  def to_microseconds(value), do: value * 2_629_746_000_000.0

  @doc """
  Converts the supplied Months value to Milliseconds
  """
  def to_milliseconds(value), do: value * 2_629_746_000.0
...
defmodule PutridParrot.Units.Nanoseconds do
  ...
  """
  def to_months(value), do: value / 2_629_746_000_000_000.0
...
defmodule PutridParrot.Units.Seconds do
  ...
  """
  def to_weeks(value), do: value / 604_800.0
...
defmodule PutridParrot.Units.Weeks do
  ...
  """
  def to_seconds(value), do: value * 604_800.0
...
defmodule PutridParrot.Units.Years do
  ...
  """
  def to_milliseconds(value), do: value * 31_556_952_000.0
  ...
  """
  def to_minutes(value), do: value * 525_600.0
